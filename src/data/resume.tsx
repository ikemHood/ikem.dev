...
export const DATA = {
  ...
  description:
    "FullStack Web3 Software Developer. I help entrepreneurs and business owners bring their software ideas to life, specializing in Web3, blockchain, and decentralized applications.",
  summary:
    "Ikem Peter is a young software developer from Nigeria in his mid-20s, skilled in full-stack and blockchain technologies. He freelances on platforms like Upwork, founded Vynix Innovation Labs Ltd., and co-founded FlareHubHQ. Previously, he worked at Horus Labs and contributed to various Web3 projects. Passionate about DeFi, AI agents, and open-source contributions, including a merged PR to Math.js. He faces challenges as a Nigerian developer but leverages local networks and remote opportunities.",
  avatarUrl: "/me.png",
  skills: [
    "JavaScript",
    "TypeScript",
  ...
  contact: {
  ...
  },  work: [
    {
      ...
      description:
        "Contributed to blockchain research and development, focusing on tokenbound accounts and decentralized products from Africa.",
    },
    {
      ...
      description:
        "Registered and leads a software development firm specializing in custom software, web and mobile applications, and IT consulting services.",
    },
    {
      company: "FlareHubHQ",
      href: "https://flarehub.org", // From search, adjust if needed
      badges: [],
      location: "Remote",
      title: "Co-Founder",
      logoUrl: "",
    ...
    },
    {
      ...
      description:
        "Developed frontend for Web3-related projects.",
    },
    {
      ...
      description:
        "Contributed to community-driven crypto projects.",
    },
    {
      company: "Kimberlite.rocks",
      href: "https://kimberlite.rocks",
      badges: [],
      location: "Remote",
      ...
      description:
        "Worked on Web3 development tasks.",
    },
    {
      company: "Climecheck.network",
      href: "https://climecheck.network",
      badges: [],
      location: "Remote",
      ...
      description:
        "Developed blockchain solutions for climate-related applications.",
    },
    {
      ...
      description:
        "Handled projects like telemedicine dApps, Solidity contract compilation in JS, and more via Upwork and referrals.",
    },
  ],
  education: [
    {
      ...
      degree: "Bachelor's Degree (Field Unknown)",
      logoUrl: "", // Add if available
      start: "Unknown",
      end: "Unknown",
    },
  ...
  projects: [
    {
      ...
      href: "https://yieldvaults.com", // Assume based on bio
      dates: "2025 - Present",
      active: true,
      description:
